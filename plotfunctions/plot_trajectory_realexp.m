function [] = plot_trajectory_realexp(mains_out, ocmains_out, in_data, magdata)
    ...
    s=pcolor(magdata.X_grid, magdata.Y_grid, reshape(29*magdata.mag_norm, size(magdata.X_grid)));
    s.EdgeColor= 'none'; 
